                                    ...
                                    <div class="p-5">
                                        ...
                                        <form action="{{ route('datos.store') }}" method="POST" class="user"
                                            ...
                                            <div class="form-group">
                                                <input class="form-control form-control-user"
                                                    placeholder="Apellidos y Nombres" type="text"
                                                    name="apellidos_nombres" id="">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="custom-file col">
                                                    ...
                                                    <label class="custom-file-label" for="customFile"
                                                        style="text-align: left">Foto</label>
                                                </div>
                                                ...
                                                <div class="form-group col">
                                                    ...
                                                    name="fecha_nacimiento" id="" onfocus="(this.type='date')">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control form-control-user" placeholder="Email"
...
@section('css')
    ...
    <link rel="stylesheet" href="/css/datos_create.css">
@stop
